...
class _ZegoVoiceChatScreenState extends State<ZegoVoiceChatScreen>
  ...
  void _endSession() async {
    ...
    if (result == true && mounted) {
      ...
      debugPrint('=== VOICE CHAT ENDING DEBUG ===');
      debugPrint('Current session: ${appState.currentSession}');
      debugPrint('Session ID: $sessionId');
      debugPrint('Current user ID: $currentUserId');
      debugPrint('Other partner: $otherPartner');
      debugPrint('Other partner ID: ${otherPartner?.id}');
      debugPrint('Other partner name: ${otherPartner?.name}');
      ...
      if (mounted) {
        debugPrint('=== NAVIGATING TO SCORING SCREEN ===');
        debugPrint('Passing sessionId: $sessionId');
        debugPrint('Passing currentUserId: $currentUserId');
        debugPrint('Passing partnerName: ${otherPartner?.name}');
        debugPrint('Passing partnerId: ${otherPartner?.id}');
