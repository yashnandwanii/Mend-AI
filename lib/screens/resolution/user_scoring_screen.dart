...
class _UserScoringScreenState extends State<UserScoringScreen>
  ...
  void initState() {
    super.initState();
    debugPrint('=== USER SCORING SCREEN INIT ===');
    debugPrint('Received sessionId: ${widget.sessionId}');
    debugPrint('Received currentUserId: ${widget.currentUserId}');
    debugPrint('Received partnerName: ${widget.partnerName}');
    debugPrint('Received partnerId: ${widget.partnerId}');
    _setupAnimations();
  ...
  Future<void> _submitRating() async {
    ...
    debugPrint('Relationship data: ${appState.relationshipData}');
